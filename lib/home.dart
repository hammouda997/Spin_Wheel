...
{return Padding(
      ...
      child: Column(
        ...
        SizedBox(height: 1),
            if (maxclicks >0)
             Text('you have: '+ maxclicks.toString()+'  spins good luck '),
            if (maxclicks == 0)
                  Text('you have no more spins left'),
            SizedBox(height: 8),]),
      );
  ...
  _buildGo() {
    return Material(
      ...
      child: InkWell(
        ...
        onTap:_ctrl.isAnimating? null : _animation,
      ),
    );
  }
    ...
    if (maxclicks <= 0)
        {
           ScaffoldMessenger.of(context).showSnackBar(   
                SnackBar(                    
                  content:Text("you have no spins left" ),
